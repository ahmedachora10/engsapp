            ...
            <div class="col-xl-6">
                ...
                <div class="card card-custom card-stretch gutter-b">
                    ...
                    <div class="card-header border-0">
                        <h3 class="card-title font-weight-bolder text-dark">الاشعارات</h3>
                    </div>
                    <!--end::Header-->
                    <!--begin::Body-->
        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label font-weight-bolder text-dark">المشاريع</span>
                    <span class="text-muted mt-3 font-weight-bold font-size-sm">اخر المشاريع المضافة</span>
                </h3>
            </div>
            <!--end::Header-->
            <!--begin::Body-->
            <div class="card-body pt-2 pb-0 mt-n3">
                ...
                @if ($userProjects->count() == 0)
                    <div class="alert alert-custom alert-light-warning fade show my-5" role="alert">
                        ...
                        <div class="alert-text">لا يوجد مشاريع مدخلة</div>
                    </div>
                @endif
                    ...
                    <table class="table table-borderless table-vertical-center">
                        ...
                        <tbody>
                            @foreach ($userProjects as $project)
                                <tr>
                                    <td class="pl-0">
                                        <a href="{{ route('admin.request.view', ['requestId' => $project->id]) }}"
                                            class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg">
                                            {{ $project->title }}
                                        </a>
                                        <span class="text-muted font-weight-bolder d-block">
                                            تاريخ الاضافة : {{ $project->created_at }}
                                        </span>
                                    </td>
                                    <td class=" pr-0">
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">التنصيف</span>
                                    ...
                                    <td class="">
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">تاريخ
                                            الانتهاء</span>
                                        <span class="text-muted font-weight-bolder">
                                            {{ date('d-m-Y', strtotime($project->deadline_date)) }}</span>
                                    </td>
                                    <td class="">
                                        @switch($project->service_stage->id)
                                            @case(1)
                                                <span class="label label-lg label-light label-inline">
                                                    {{ $project->service_stage->name }}</span>
                                            @break
                                            @case(2)
