        ...
        <div class="card card-custom card-stretch">
            ...
            <div class="card-header py-3">
                <div class="card-title align-items-start flex-column">
                    <h3 class="card-label font-weight-bolder text-dark">عضوية الهيئة السعودية للمهندسين</h3>
                    <span class="text-muted font-weight-bold font-size-sm mt-1">اعتماد عضوية الهيئة السعودية للمهندسين المستقلين</span>
                </div>
            ...
            <form class="form" id="userDetailsForm" method="post"
                action="{{ route('admin.freelancer.membership', ['userId' => $user->id]) }}">
                @csrf
                <!--begin::Body-->
