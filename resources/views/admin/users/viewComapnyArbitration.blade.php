...
@php
$curr='خدمة التحكيم';
if($currentPage == 'testBuild'){
    $curr='خدمة فحص المباني الجاهزة';
}
if($currentPage == 'testQuality'){
    $curr='خدمات فحص الجودة';
}
@endphp
@section('UserContent')
    <!--begin::Content-->
        ...
        <div class="card card-custom card-stretch">
            ...
            <div class="card-header py-3">
                <div class="card-title align-items-start flex-column">
                    <h3 class="card-label font-weight-bolder text-dark">تفعيل {{$curr}}</h3>
                    <span class="text-muted font-weight-bold font-size-sm mt-1">تفعيل {{$curr}} الخاص
                        بالمنصة</span>
                </div>
                ...
                <div class="card-body">
                    ...
                    @foreach ($fields as $key => $section)
                        ...
                        @foreach ($section as $field)
                            @if ($field->id == 'arbitrationcert_request_status')
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="d-flex flex-row">
                                            @if (isset($field->value))
                                                @if ($field->value == 1)
                                                    <span class="label label-xl label-light-warning label-inline ml-3">
                                                        يطلب تفعيل الخدمة
                                                    </span>
                                                @else ($field->value == 0)
                                                    <span class="label label-xl label-light-primary label-inline ml-3">
                                                        تم الطلب والتحديث مسبقاً
                                                    </span>
                                                @endif
                                            @else
