                ...
                <div class="card card-custom card-sticky" id="kt_page_sticky_card">
                    <div class="card-header">
                        ...
                        <div class="card-title">
                            <h3 class="card-label"> محتوى صفحة : {{ $page_name_text }}
                            </h3>
                        </div>
                        ...
                        @foreach ($content as $sectionKey => $sectionValue)
                            ...
                            @foreach ($sectionValue as $pargraph)
                                <div class="form-group row">
                                    @if (strpos($pargraph->paragraph_name, 'project_type_') !== false)
                                    <div
                                        class="col-form-label text-lg-right col-lg-3 col-sm-12 font-weight-bolder">
                                        <label for="">{{ $pargraph->paragraph_name_text }}</label>

                                        <div style="    display: flex;
    justify-content: flex-end;">
                                            <span class="switch switch-icon">
                                                <label>
                                                    <input type="checkbox" value="1" id="{{ $pargraph->paragraph_name }}_active"  name="{{ $pargraph->paragraph_name }}_active" {{ $pargraph->is_active ==1?'checked="checked"':''}}/>
                                                    <span></span>
                                                </label>
                                            </span>
                                        </div>
                                        ...
                                        @else
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control autosise_textarea"
                                                    ...
                                                    style="overflow: hidden; overflow-wrap: break-word; resize: none; height: 100px;">{{ $pargraph->content_ar }}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control autosise_textarea"
                                                    ...
                                                    style="overflow: hidden; overflow-wrap: break-word; resize: none; height: 100px;">{{ $pargraph->content_en }}</textarea>
                                            </div>
                                        @endif
