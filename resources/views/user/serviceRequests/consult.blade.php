<x-layout>
    <div class="container">
        <div class="row mt-3 mb-5 mx-md-0">
            ...
            <form id="request-service" action="{{ route('user.request.consult') }}" enctype="multipart/form-data"
                method="POST"
                ...
                <div class="bg-white d-flex flex-column flex-fill">
                    <div class="service-request-header-block">
                        <div class="d-flex justify-content-between pt-5 px-4 pb-3">
                            <div class="text-content">
                                <h1>الرجاء تحديد نوع المشروع</h1>
                                <p class="mt-2">يمكنك طلب عدة خدمات للمكاتب الهندسية المعتمدة في الجهات الحكومية ذات العلاقة</p>
                            </div>
                    ...
                    <div class="">
                        <div class="request-service-slider">
                            ...
                            <div class="subservices-checklist pt-4 px-4">
                                <ul class="d-flex flex-wrap row-cols-1">
                    ...
                    <div class="d-flex flex-row justify-content-center mb-4 mt-auto px-5 text-center">
                        <a href="#" class="btn btn-46 btn-step d-inline-block btn-prev mr-3">
                            رجوع</a>
                        <button type="submit" class="btn btn-primary has-shadow btn-46 btn-step d-inline-block btn-next">
