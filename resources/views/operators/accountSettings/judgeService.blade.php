        ...
        <div class="row mt-3 mb-5 mx-md-0">
            ...
            <div class="col-lg-9 pl-xl-3">
                <div class="border-radius-8 bg-white d-flex flex-column p-md-5 py-4 px-3">
                    <x-alert />
                    <form id="requestJudgeService" action="{{ route('operator.judgeService') }}"
                        enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="row account-judge-service">
                            <div class="col-md-8">
                                <h1 class="mb-2">خدمة التحكيم</h1>
                                <p class="account-judge-service-note mb-4">لتتمع بتقديم خدمة التحكيم للعملاء يجب ارسال
                                    شهادة
                                    من النقابة تجيز التحكيم
                                ...
                                <div class="col-md-3 offset-md-1">
                                    <label for="arbitration"
                                        ...
                                        <div class="text-center SelectPreviewBox">
                                            ...
                                            <span class="title mb-2">شهادة التحكم</span>
                                    ...
                                    <p class="arbitration-attach-file-desc text-center mt-1">قم بارفاق شهادة التحكم</p>
                            ...
                            @if ($request_status && $status == false)
                                <div class="col-md-12 mt-4">
                                    <p class="account-judge-service-note text-danger">
                                        طلب تفعيل خدمة التحكيم قيد المراجعة من قبل إدارة المنصة
                                    </p>
                                </div>
                            @endif
                        </div>
