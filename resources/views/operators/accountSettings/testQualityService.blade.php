        ...
        <div class="row mt-3 mb-5 mx-md-0">
            ...
            <div class="col-lg-9 pl-xl-3">
                <div class="border-radius-8 bg-white d-flex flex-column p-md-5 py-4 px-3">
                    <x-alert />
                    <form id="requestJudgeService" action="{{ route('operator.testQualityService') }}"
                        enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="row account-judge-service">
                            <div class="col-md-8">
                                <h1 class="mb-2">خدمات فحص الجودة</h1>
                                <p class="account-judge-service-note mb-4">لتتمع بتقديم خدمات فحص الجودة للعملاء يجب ارسال
                                    شهادة
                                    فحص جودة البناء
                                ...
                                <div class="col-md-3 offset-md-1">
                                    <label for="arbitration"
                                        ...
                                        <div class="text-center SelectPreviewBox">
                                            ...
                                            <span class="title mb-2">شهادة فحص جودة البناء</span>
                                    ...
                                    <p class="arbitration-attach-file-desc text-center mt-1">قم بارفاق شهادة فحص جودة البناء</p>
                                    <span id="errorNum1"></span>

                                    <label for="insurance_copy"
                                        class="arbitration-file-upload d-flex flex-column mt-5 justify-content-center align-items-center">
                                        <input type="file" id="insurance_copy" style="display: none;" name="insurance_copy"
                                            accept="application/pdf, image/jpeg" data-error="#errorNum2" />
                                        <div class="text-center SelectPreviewBox">
                                            <img src="{{ asset('images/upload-icon.svg') }}" class="mb-4">
                                            <span class="title mb-2">شهادة التأمين المهني</span>
                                            <span class="file-type font-Roboto">PDF-jpg</span>
                                        </div>
                                        <div class="FilePreview" style="display: none">
                                            <div class=" align-items-center d-flex flex-row px-3">
                                    ...
                                    <p class="arbitration-attach-file-desc text-center mt-1">قم بارفاق شهادة التأمين المهني</p>
                            ...
                            @if ($request_status && $status == false)
                                <div class="col-md-12 mt-4">
                                    <p class="account-judge-service-note text-danger">
                                        طلب تفعيل خدمة فحص جودة البناء قيد المراجعة من قبل إدارة المنصة
                                    </p>
                                </div>
                            @endif
                        </div>
        ...
        <script>
            $(function() {
                ...
                $("#arbitration").change(function(e) {
                    ...
                    let SelectPreviewBox = $(this).parent().children('.SelectPreviewBox')
                    let FilePreview = $(this).parent().children('.FilePreview')
                    if ($(this).val().length == 0) {
                        ...
                        FilePreview.find('.filename').text(filename);
                        FilePreview.find('.FilePreview-img').html(FileTypeImg);
                    }


                });

                $("#insurance_copy").change(function(e) {
                    // console.log($(this).val());
                    let SelectPreviewBox = $(this).parent().children('.SelectPreviewBox')
                    let FilePreview = $(this).parent().children('.FilePreview')
                    if ($(this).val().length == 0) {
